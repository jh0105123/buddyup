...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBjlovEy105yLBFH6Lrg_brtigJc2AJF-s&libraries=places&callback=initMap"
async defer></script>
...
<body>
<!-- 	<div class="row">
		<div id="sideNav" class="col-md-3">ㅇㅇ</div>
		<div class="col-md-9">
